...
var time = 5; 
// var countdown = setInterval(endGame, 1000);
...
checkAnswer: function(action){
  ...
  win: function(){
      //need to delete button(s)    clearInterval(countdown)
    ...
    $('.modal-hidden').toggleClass('modal').html(0);
},
...
//   function endGame(){
//   console.log('endGame is being called')
//   time--
